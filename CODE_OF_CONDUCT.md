...
- Posting in this repository's Issues, Pull Requests, or Discussions
- Commenting on commits or releases
- Representing the project at online or offline events
- Acting as an appointed representative

## Enforcement

This is a small project with a single maintainer. Reports of abusive,
harassing, or otherwise unacceptable behavior should be sent to:
...
The maintainer will follow these guidelines when determining
consequences for any action deemed in violation of this Code of
Conduct:
...
- The maintainer reserves the right to remove any contribution or ban
  any participant at their discretion.
- Disagreements about the project's direction are not Code of Conduct
  issues — they're normal discussions. The Code of Conduct is about
  *how* we disagree, not *what* we disagree about.
